				...
				<div className="center align_center ps_rel">
					...
					<svg className="page-cover__dots1" width="190" height="130" viewBox="0 0 190 130">
					    <g fill="#4DA1FF" fillRule="evenodd">
					        <circle cx="95" cy="125" r="5"/><circle cx="65" cy="125" r="5"/><circle cx="35" cy="125" r="5"/><circle cx="95" cy="95" r="5"/><circle cx="65" cy="95" r="5"/><circle cx="35" cy="95" r="5"/><circle cx="125" cy="65" r="5"/><circle cx="155" cy="65" r="5"/><circle cx="185" cy="65" r="5"/><circle cx="95" cy="65" r="5"/><circle cx="65" cy="65" r="5"/><circle cx="35" cy="65" r="5"/><circle cx="125" cy="35" r="5"/><circle cx="155" cy="35" r="5"/><circle cx="185" cy="35" r="5"/><circle cx="95" cy="35" r="5"/><circle cx="65" cy="35" r="5"/><circle cx="35" cy="35" r="5"/><circle cx="5" cy="35" r="5"/><circle cx="125" cy="5" r="5"/><circle cx="155" cy="5" r="5"/><circle cx="185" cy="5" r="5"/><circle cx="95" cy="5" r="5"/><circle cx="65" cy="5" r="5"/><circle cx="35" cy="5" r="5"/><circle cx="5" cy="5" r="5"/>
					    </g>
					</svg>

					<svg className="page-cover__dots2" width="190" height="70" viewBox="0 0 190 70">
					    <g fill="#4DA1FF" fillRule="evenodd">
					        <circle cx="125" cy="65" r="5"/><circle cx="185" cy="65" r="5"/><circle cx="95" cy="65" r="5"/><circle cx="65" cy="65" r="5"/><circle cx="35" cy="65" r="5"/><circle cx="95" cy="35" r="5"/><circle cx="65" cy="35" r="5"/><circle cx="35" cy="35" r="5"/><circle cx="5" cy="35" r="5"/><circle cx="95" cy="5" r="5"/><circle cx="65" cy="5" r="5"/><circle cx="35" cy="5" r="5"/><circle cx="5" cy="5" r="5"/>
					    </g>
					</svg>
