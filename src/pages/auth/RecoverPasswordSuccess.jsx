	...
	return(
		...
		<AuthPanel>
			...
			<div className="align_center">
				...
				<span onClick={props.dispatchToLogin} className="auth-pane__footlink">Войти</span>
			</div>
