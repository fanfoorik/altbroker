      ...
      <AuthPanel>
        {user.error &&
          <div className="align-center">
            <div className="mb_36">
              ...
              <svg width="80" height="80" viewBox="0 0 80 80">
                <g fill="none" fillRule="evenodd">
                  ...
                  <path stroke="#D0011B" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4"
                        d="M40.5 40.5L26.567 26.567 40.5 40.5 54 27 40.5 40.5zm0 0L27 54l13.5-13.5 12.957 12.957L40.5 40.5z"/>
                </g>
              </svg>
            ...
            <div className="align-center">
              <span
                className="auth-pane__footlink"
                onClick={this.props.dispatchToRecoverEmail}
                role="button"
                tabIndex="0"
              >Восстановить пароль ещё раз</span>
            </div>
          </div>
        }
