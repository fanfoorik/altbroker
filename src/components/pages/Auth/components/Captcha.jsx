      ...
      <div className="captcha">
        ...
        <div className="clear">
          <div className="captcha__image mb-12">
            <img src={hostUrl + captcha.image} alt="Капча" />
          </div>
